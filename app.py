...
# --- 5. UI + 투명한 눈 결정체 (화면 가림 해결) ---
st.markdown("""
<style>
    /* 전체 컨테이너 */
    .main > div { overflow: visible !important; }
    .stApp { overflow: visible !important; background: #000000; color: #ffffff; font-family: 'Playfair Display', serif; position: relative; }

    /* 제목 */
    .main-title { text-align: center; margin: 20px 0 40px; line-height: 1.2; z-index: 20; position: relative; }
    ...
    /* 탭 버튼 */
    .stButton > button { 
        background: #8B0000 !important; color: #FFFFFF !important; border: 2px solid #FFD700 !important; 
        border-radius: 14px !important; padding: 14px 30px !important; font-weight: 600; font-size: 1.1em; 
        box-shadow: 0 4px 20px rgba(255, 215, 0, 0.3); z-index: 20; position: relative;
    }
    .stButton > button:hover { background: #B22222 !important; transform: translateY(-3px); box-shadow: 0 8px 30px rgba(255, 215, 0, 0.5); }

    /* 공지 */
    .streamlit-expanderHeader { 
        background: #006400 !important; color: #FFFFFF !important; border: 2px solid #FFD700; 
        border-radius: 12px; padding: 14px 18px; font-size: 1.05em; z-index: 15; position: relative;
    }
    .streamlit-expander { 
        background: rgba(0, 100, 0, 0.7) !important; border: 2px solid #FFD700; 
        border-radius: 12px; margin-bottom: 14px; z-index: 15; position: relative;
    }
    ...
    .stDateInput > div > div > input {
        background: #FFFFFF !important; color: #000000 !important; border: 2px solid #DC143C !important; 
        border-radius: 10px; z-index: 15; position: relative;
    }
