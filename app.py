# app.py - 칸타타 투어 2025 (최종 완전판 + 라인 방향 평행 텍스트) 🎄
# 라벨: 라인과 **정확히 같은 방향** (회전 보정 완벽) + 말풍선 없음 + 위쪽 배치
