...
def add_notice(title, content, img=None, file=None):
    ...
    st.session_state.seen_notices = []; st.session_state.new_notice = True; st.session_state.tab_selection = _("tab_notice"); st.rerun()
...
if st.session_state.get("new_notice", False):
    st.session_state.tab_selection = _("tab_notice"); st.session_state.new_notice = False; st.rerun()
