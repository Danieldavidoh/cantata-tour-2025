...
<style>
    ...
    /* 헤더: 아이콘 + 제목 + 버튼 (최상단부터) */
    .header {
        flex: 0 0 auto; text-align: center; padding: 0; margin: 0;
    }
    ...
    .button-row {
        display: flex; justify-content: center; gap: 15px; margin: 0 !important; padding: 0;
    }
    .tab-btn {
    ...
    .overlay-content {
        ...
        z-index: 999; padding: 15px; overflow-y: auto; display: none; flex-direction: column;
    }
    .overlay-content.open { display: flex; }
...
if st.session_state.notice_open:
    st.markdown('<div class="overlay-content open">', unsafe_allow_html=True)
