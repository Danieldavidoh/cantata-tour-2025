...
if st.session_state.admin:
    ...
    # 공지현황 토글
    show_status = st.toggle(_["notice_status"], value=st.session_state.show_notice_status, key="show_notice_status")
    st.session_state.show_notice_status = show_status  # 상태 동기화
