...
LANG = {
    ...
    "hi": {
        ...
        "change_admin_pw": "व्यवस्थापक पासवर्ड बदलें",
        "new_password": "नया पासवर्ड",
        "confirm_password": "पासवर्ड की पुष्टि करें",
        "delete_schedule": "सभी अनुसूची हटाएं"
    }
}
...
# --- 관리자 및 UI 설정 ---
ADMIN_PASS_KEY = "ADMIN_PASS" # 세션 상태 키
DELETE_PASS = "0691"
...
# ADMIN_PASS 초기화 및 가져오기
if ADMIN_PASS_KEY not in st.session_state:
    st.session_state[ADMIN_PASS_KEY] = "0009"
ADMIN_PASS = st.session_state[ADMIN_PASS_KEY]
...
def clear_all_data():
    ...
    try:
        ...
        st.session_state[ADMIN_PASS_KEY] = ADMIN_PASS # 비밀번호 복구
