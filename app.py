...
# 1. 공지사항 섹션 (항상 표시)
# ========================================
st.markdown(f'<div class="section-title">📢 {_("tab_notice")}</div>', unsafe_allow_html=True)
...
# 2. 투어 지도 섹션 (항상 표시)
# ========================================
st.markdown(f'<div class="section-title">🗺️ {_("tab_map")}</div>', unsafe_allow_html=True)
