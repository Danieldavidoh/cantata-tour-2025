...
<style>
    ...
    .christmas-decoration i {
        ...
        animation: float 3s ease-in-out infinite; opacity: 0.95; font-size: 2.2em;
    }
    ...
    .main-title {
        ...
        text-shadow: 0 3px 8px rgba(0,0,0,0.6); margin: 5vh 0 20px 0 !important; line-height: 1.2;
    }

    /* 버튼 라인 */
    .button-row {
        display: flex; justify-content: center; gap: 20px; margin: 0 0 30px 0; padding: 0 15px;
    }
    .tab-btn {
    ...
    .snowflake {
        ...
        animation: fall linear infinite; opacity: 0.6; z-index: -1; text-shadow: 0 0 5px #fff;
    }
    @keyframes fall { 0% { transform: translateY(0) rotate(0deg); opacity: 0.6; } 100% { transform: translateY(120vh) rotate(360deg); opacity: 0; } }
